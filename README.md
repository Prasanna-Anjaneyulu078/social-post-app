...
A responsive MERN stack social media application built for the 3W Full Stack Internship Assignment. Inspired by the TaskPlanet app, it features a mobile-first UI for real-time social interaction.
